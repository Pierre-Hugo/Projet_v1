...
wss.on("connection", (ws) => {
    ...
    ws.on("message", data => {
        ...
        const firstColonIndex = messageStr.indexOf(':');
        const targetClientId = messageStr.slice(0, firstColonIndex);
        const messageContent = messageStr.slice(firstColonIndex + 1);
